...
def record_claim(
    ...
    Args:
        ...
        source_id: The id of a source already returned by web_search/web_fetch.
    ...
    if source_id not in dr_sources:
        return _reject(tool_call_id, f"source_id {source_id!r} not found -- cite an id from a prior web_search/web_fetch result.")
